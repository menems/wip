// Tests live in package auth (not auth_test) because the mock types
...
func testService(t *testing.T, repo *mockRepo) *Service {
	t.Helper()
	return NewService(repo, repo, TokenConfig{
